        ...
        <ThemeProvider theme={mytheme}>
          <div className={classes.paper}>
            ...
            <form className={classes.form}>
                ...
                onKeyPress={async (event) => {
                  ...
                  if (4 <= password.length && password.length <= 20) {
                    ...
                    if (userDatas.value === "Duplicate Email") {
                      ...
                      const userDatas = await postLogin(
                        `${server.ip}/user/login`,
                        userID,
                        password
                      );
                      if (userDatas === true) {
              ...
              <IconButton
                href={
                  "https://accounts.google.com/o/oauth2/v2/auth?client_id=14050797265-gchj4gpfqu6fmdet41v1g34mc53hdoic.apps.googleusercontent.com&redirect_uri=" +
                  server.ip +
                  "/callback/google&response_type=code&scope=profile"
                }
              >
                Google
              </IconButton>
              <Button
                ...
                href={
                  "https://github.com/login/oauth/authorize?client_id=2d34711451a62f8f967d&redirect_uri=" +
                  server.ip +
                  "/callback/github"
                }
              ...
              <IconButton
                href={
                  "https://kauth.kakao.com/oauth/authorzie?client_id=c765ccaf81f7ec64ac9adacbe5f8beb7&redirect_uri=" +
                  server.ip +
                  "/callback/kakao&response_type=code"
                }
              >
                Kakao
              </IconButton>
                      ...
                      Kakao.API.request({
                        ...
                        success: async function (response) {
                          ...
                          if (data.data.value === "Success") history.push("/");
                            ...
                            alert("로그인 과정에서 예상치 못한 문제가 발생했습니다.");
                        },
                        fail: function (error) {
                          alert("로그인 중 에러 발생");
                        },
