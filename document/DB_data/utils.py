...
class DB:
    ...
    def get_UserProducts_Classifi1(self, user_id, classifi1):
        ...
        '''
        data = []
        dict_keys = ['upID', 'item_name', 'item_count', 'item_createDay', 'item_category1', 'item_expDay', 'item_category2']
        cursor = self.db.cursor()
        sql = "SELECT upID, productName, productCount, createdDate, productClassification1, productShelfLife, productClassification2 " \
